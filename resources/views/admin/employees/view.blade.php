  ...
  <div class="col-md-8">
    ...
    <div class="col-md-4">
          <div class="mb-4" style="border: 1px solid var(--ccp-primary-color-maroon); border-radius: 5px;">
            ...
            <button action="" class="btn btn-success btn-sm mb-3 mx-3" style="padding: 8px">Completed</button>
            <button action="" class="btn btn-danger btn-sm mb-3 mx-3" style="padding: 8px">No Show</button>
            </div>
          </div>
...
>>>>>>> Stashed changes
  ...
  <div class="mt-4" style="border: 1px solid var(--ccp-primary-color-maroon); border-radius: 5px;">
    ...
    <!-- form container js - moved outside flex container -->
